...
echo "<select datatype='LIST' name='homespace_StmtMonth' xmlname='StmtMonth' id='StmtMonth' xml='N' parent='homespace' class='ctext' value='C' mndf='Y' label='Statement' onchange='javascript:onChange(this);' onkeydown='javascript:onKeyDown(this);' onkeypress='javascript:onKeyPress(this);' onkeyup='javascript:onKeyUp(this);'> <option value=''> ALL </option>";
