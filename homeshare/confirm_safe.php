...
<form name="form1" xmlname="homeconfirm" method="POST">
<div class="cform">
...
//	creatNewTbl();
	...
	<table>
		<tr>
			<td>	
				<center>
				<input type="button" class="button" parent="homeconfirm" task="back"     value="back" onclick="javascript:onClick(this)" >
				<input type="button" class="button" parent="homeconfirm" task="validate" value="validate" onclick="javascript:onClick(this)" >
				<input type="button" class="button" parent="homeconfirm" task="submit"   value="submit"   onclick="javascript:onClick(this)" >
				</center>
			</td>
		</tr>
	</table>
