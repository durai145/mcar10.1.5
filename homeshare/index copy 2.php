...
//"http://www.homespace.heaerie.com/mcar10.1.4/homeshare/signup_ac.php",
	...
	//		autoOpen: true,
		...
		$( "#login-user" )
			...
			.click(function() {
//				$( "#dialog-form" ).dialog( "open" );
					bValid = bValid && checkLength( fm1email, "email", 6, 80 );
					bValid = bValid && checkLength( fm1password, "password", 6, 16 );
				document.forms[0].submit();
			});
	});
	</script>
...
<div id="dialog-form1" title="Login" class="ui-widget">
...
<td width="6">:</td>
<td width="294"><input name="myusername" type="text" id="myusername"   class="text ui-widget-content ui-corner-all"></td>
</tr>
<tr>
<td>Password</td>
<td>:</td>
<td><input name="mypassword" type="password" id="mypassword"  class="text ui-widget-content ui-corner-all"></td>
</tr>
<tr>
<td>&nbsp;</td>
<td>&nbsp;</td>
