...
var glCrbPer1Flg="<?php echo $_POST['homeverify_CrbPer1Flg'] ?>";
var glCrbPer2Flg="<?php echo $_POST['homeverify_CrbPer2Flg'] ?>";
var glCrbPer3Flg="<?php echo $_POST['homeverify_CrbPer3Flg'] ?>";
var glCrbPer4Flg="<?php echo $_POST['homeverify_CrbPer4Flg'] ?>";
var glCrbPer5Flg="<?php echo $_POST['homeverify_CrbPer5Flg'] ?>";
...
var glBalDiff="<?php echo $_POST['homeverify_BalDiff'] ?>";
var glrlt    ="<?php echo $_POST['homeverify_rlt'    ] ?>";
</script>

<?php
	
$qry="INSERT INTO `home_transaction` (`SNO`, `REF_NO`, `DESC`, `SPEN_AMT`, `SHAR_CNT`, `SHAR_AMT`, `CNTRB_PER_1_FLG`, `CNTRB_PER_2_FLG`, `CNTRB_PER_3_FLG`, `CNTRB_PER_4_FLG`, `CNTRB_PER_5_FLG`, `CNTRB_PER_1`, `CNTRB_PER_2`, `CNTRB_PER_3`, `CNTRB_PER_4`, `CNTRB_PER_5`, `CNTRB_PER_TTL`, `BALNC_PER_1`, `BALNC_PER_2`, `BALNC_PER_3`, `BALNC_PER_4`, `BALNC_PER_5`, `BALNC_TTL`, `DIFF`, `MENU`, `MAKER_ID`, `MAKER_DT`, `AUTH_ID`, `AUTH_DT`, `VAL_DT`) VALUES";
$qry=$qry. "('". $_POST['homeverify_Sno'      ] ."', ";
$qry=$qry. "'". $_POST['homeverify_RefNo'     ] ."', ";
$qry=$qry. "'". $_POST['homeverify_Descr'     ] ."', ";
$qry=$qry. "'". $_POST['homeverify_SpndAmt'   ] ."', ";
$qry=$qry. "'". $_POST['homeverify_ShrCnt'    ] ."', ";
$qry=$qry. "'". $_POST['homeverify_ShrAmt'    ] ."', ";
$qry=$qry. "'". $_POST['homeverify_CrbPer1Flg'] ."', ";
$qry=$qry. "'". $_POST['homeverify_CrbPer2Flg'] ."', ";
$qry=$qry. "'". $_POST['homeverify_CrbPer3Flg'] ."', ";
$qry=$qry. "'". $_POST['homeverify_CrbPer4Flg'] ."', ";
$qry=$qry. "'". $_POST['homeverify_CrbPer5Flg'] ."', ";
$qry=$qry. "'". $_POST['homeverify_CrbPer1'   ] ."', ";
$qry=$qry. "'". $_POST['homeverify_CrbPer2'   ] ."', ";
$qry=$qry. "'". $_POST['homeverify_CrbPer3'   ] ."', ";
$qry=$qry. "'". $_POST['homeverify_CrbPer4'   ] ."', ";
$qry=$qry. "'". $_POST['homeverify_CrbPer5'   ] ."', ";
$qry=$qry. "'". $_POST['homeverify_CrbTtl'    ] ."', ";
$qry=$qry. "'". $_POST['homeverify_BalPer1'   ] ."', ";
$qry=$qry. "'". $_POST['homeverify_BalPer2'   ] ."', ";
$qry=$qry. "'". $_POST['homeverify_BalPer3'   ] ."', ";
$qry=$qry. "'". $_POST['homeverify_BalPer4'   ] ."', ";
$qry=$qry. "'". $_POST['homeverify_BalPer5'   ] ."', ";
$qry=$qry. "'". $_POST['homeverify_BalTtl'    ] ."', ";
$qry=$qry. "'". $_POST['homeverify_BalDiff'   ] ."', ";
$qry=$qry. "'HS', '10', '2012-12-11', '10', '2012-12-11', '2012-12-11');";
...
$con = mysql_connect("localhost","u1021977_admin","india");
if (!$con)
{
...
<form name="form1" xmlname="homeverify" method="POST">
<div class="cform">
	...
	fld.label="S.No"
	fld.desc="N"
	fld.group="homeverify"
	fld.mndf="Y";
	fld.dataType="LABEL"
	fld.parent="homeverify"
	fld.xml="N"
...
//	fld.dataType="LABEL"
	...
	<table>
		<tr>
			<td>	
				<center>
				<input type="button" class="button" parent="homeverify"  task="VALIDATE" value="validate" onclick="javascript:onClick(this)" >
				<input type="button" class="button" parent="homeverify"  task="SUBMIT"   value="submit"   onclick="javascript:onClick(this)" >
				</center>
			</td>
		</tr>
	</table>
