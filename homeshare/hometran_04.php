...
prcDate =  date.getDate() + '/' + ( ( date.getMonth().toString()  )+1)  + '/' +  date.getFullYear();
bizDate=date.getDate() + '/' + ( ( date.getMonth().toString()  )+1)  + '/' +  date.getFullYear();
sysDate=date.getDate() + '/' + ( ( date.getMonth().toString()  )+1)  + '/' +  date.getFullYear();
...
<div class="cform">
	...
	creatNewTbl();
	fnCreateCaption("Do Transaction ");
	fld.name="FuncCode"
	fld.label="Function"
	fld.desc="N"
	fld.group="homespace"
