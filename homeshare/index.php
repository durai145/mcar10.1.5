...
<div class="demo">
<input type="text" name="GrpId" id="GrpId" placeholder="Grp Id" class="text ui-widget-content ui-corner-all" >
<input type="text" name="GrpName" id="GrpName" placeholder="Grp Name" class="text ui-widget-content ui-corner-all" >
...
<div id="dialog-form" title="Add New User">
	...
	<fieldset>
		<table border=0>
			...
			<td>
			<input type="text" name="GroupName" id="GroupName" placeholder="Name of Group" class="text ui-widget-content ui-corner-all" />
			</td>
			</tr>
...
<div class="toggler">
	<div id="effect" class="newClass ui-corner-all">
		<img src="../img/favicon.png" width="30px" height="20px" />
...
<button id="create-user">Sign UP Group</button>
