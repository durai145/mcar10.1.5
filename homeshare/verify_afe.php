...
var glRefNo  ="<?php echo $_POST['homespace_RefNo'  ] ?>";
...
var glCrbPer1="<?php echo $_POST['homespace_CrbPer1'] ?>";
var glCrbPer1="<?php echo $_POST['homespace_CrbPer1'] ?>";
var glCrbPer2="<?php echo $_POST['homespace_CrbPer2'] ?>";
var glCrbPer3="<?php echo $_POST['homespace_CrbPer3'] ?>";
var glCrbPer4="<?php echo $_POST['homespace_CrbPer4'] ?>";
var glCrbPer5="<?php echo $_POST['homespace_CrbPer5'] ?>";
var glCrbTtl ="<?php echo $_POST['homespace_CrbTtl' ] ?>";
var glBalPer1="<?php echo $_POST['homespace_BalPer1'] ?>";
var glBalPer2="<?php echo $_POST['homespace_BalPer2'] ?>";
var glBalPer3="<?php echo $_POST['homespace_BalPer3'] ?>";
var glBalPer4="<?php echo $_POST['homespace_BalPer4'] ?>";
var glBalPer5="<?php echo $_POST['homespace_BalPer5'] ?>";
 ...
 fnCreateField(fld);
	...
	<table>
		<tr>
			<td>	
				<center>
				<input type="button" class="button" parent="homeverify" task="BACK"     value="back" onclick="javascript:onClick(this)" >
