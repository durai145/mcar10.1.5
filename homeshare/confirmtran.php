...
$param= "homespace_CrbPer_" . $dataArr[3];
$param_flg= "homespace_CrbPer_" . $dataArr[3] . "Flg";
$param_shr= "homespace_shr_" . $dataArr[3];
$param_shr_flg= "homespace_shr_" . $dataArr[3] . "Flg";
$param_bal= "homespace_bal_" . $dataArr[3];
/*--
if ( $_POST[$param]  == ""  )
{
	 $_POST[$param] = 0;
...
$rtval= "//{$param} " . "|" .    $_POST['homespace_CrbPer_1'  ]   .  "|". $_POST[$param]  . "   \n document.getElementById('CrbPer_".  $dataArr[3]  . "').value  = '".  $_POST[$param] ."' ;\n";
$rtval= " document.getElementById('CrbPer_".  $dataArr[3]  . "').value  = '".  $_POST[$param] ."' ;\n";
$rtval.= " document.getElementById('shr_".  $dataArr[3]  . "').value  = '".  $_POST[$param_shr] ."' ;\n";
$rtval.= " document.getElementById('bal_".  $dataArr[3]  . "').value  = '".  $_POST[$param_bal] ."' ;\n";
$rtval.= " document.getElementById('CrbPer_".  $dataArr[3]  . "Flg').value  = '".  $_POST[$param_flg] ."' ;\n";
$rtval.= " document.getElementById('CrbPer_".  $dataArr[3]  . "Flg').disabled  = true ;\n";
$rtval.= " document.getElementById('shr_".  $dataArr[3]  . "Flg').disabled  = true ;\n";
	return $rtval;
}
