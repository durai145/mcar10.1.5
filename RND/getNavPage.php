...
$in_page_grp_key=$_SESSION['PAGEGRPKEY']; 
$in_page_key=$_SESSION['PAGEKEY']; 
//echo "$usrid";
//$usrid="41";
...
and page_grp_key='" . $in_page_grp_key . "' 
...
if ( $in_page_key  ==   $page_key )
{
echo "<li><a href=\"" . $page_name . "\" class=\"active\" > " . $page_key . "</a> </li>"  ;
}
else
{
echo "<li><a href=\"" . $page_name . "\" > " . $page_key . "</a> </li>"  ;
}
}
