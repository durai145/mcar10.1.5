...
/*[
	...
	.column_acctdtl{ width:750px; float: left; padding-bottom: 100px; }
	.column_queue  { width: 300px; float: left; padding-bottom: 100px; }
	...
	div#users-contain { width: 340px; margin: 20px 0; }
...
<div class="column">
	...
	<div class="portlet">
		...
		<div class="portlet-content" id="UserDtl"><img src="../img/ajax-loader.gif"> </img></div>
	...
	<div class="portlet">
		...
		<div class="portlet-content" id="GrpMember"><img src="../img/ajax-loader.gif"> </img></div>
...
<div class="column">
  ...
  <table> <tr> <td>Transaction Details  </td> <td>  <div id="StmtMonthDiv"> </div> </td> </tr> </table> </div>
		<div class="portlet-content" id="txnDtl"><img src="../img/ajax-loader.gif"> </img></div>

	</div>
	<div class="portlet">
		<div class="portlet-header">Members Chart </div>
		<!--div class="portlet-content" id="GrpMember"><img src="../img/ajax-loader.gif"> </img></div-->

 <div><span>You Clicked: </span><span id="info1">Nothing yet</span></div>
        
    <div id="chart1" style="margin-top:20px; margin-left:20px; width:470px; height:300px;">
