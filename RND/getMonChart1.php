...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
    ...
    <script type="text/javascript" src="./Bar Charts_files/jquery.min.js"></script>
...
<!-- Additional plugins go here -->
  ...
  <script type="text/javascript" src="./Bar Charts_files/jqplot.barRenderer.min.js"></script>
  <script type="text/javascript" src="./Bar Charts_files/jqplot.pieRenderer.min.js"></script>
  <script type="text/javascript" src="./Bar Charts_files/jqplot.categoryAxisRenderer.min.js"></script>
  <script type="text/javascript" src="./Bar Charts_files/jqplot.pointLabels.min.js"></script>
